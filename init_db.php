...
try {
    ...
    // Create mainpage table
    echo "<h2>Creating Mainpage Table</h2>";
    ...
    $conn->exec($sql_mainpage);
    echo "<p style='color:green;'>✓ Mainpage table created successfully</p>";
    ...
    // Insert mainpage data
    echo "<h2>Populating Mainpage Table</h2>";

    // Main page content (this should match the content from mainpage_edit.js)
    ...
    $sql_insert_mainpage = "
    INSERT INTO mainpage (content) VALUES (:content)
    ";
