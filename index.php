...
<body>
    ...
    <div id="admin-edit-link" class="hide-on-mobile admin-only admin-only-hidden" style="text-align: center; margin: 30px 0; padding: 20px; background-color: #f8f9fa; border-radius: 8px;">
