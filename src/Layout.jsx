...
import { BookOpen, Image, Mail, Calendar, Menu, X, ChevronDown, Home } from "lucide-react";
      ...
      <footer className="bg-[#2d6b7a] text-white py-6 px-6 pb-24 md:pb-6">
        ...
        <div className="hidden md:flex max-w-5xl mx-auto items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            ...
            <a href="https://www.instagram.com/sivanhackam/" target="_blank" rel="noopener noreferrer" title="Instagram"
              ...
              <svg className="w-5 h-5" fill="url(#ig-grad-footer)" viewBox="0 0 24 24">
                <defs><linearGradient id="ig-grad-footer" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stopColor="#F58529"/><stop offset="50%" stopColor="#E1306C"/><stop offset="100%" stopColor="#833AB4"/></linearGradient></defs>
        ...
        <div className="md:hidden flex flex-col items-center gap-4">
          ...
          <div className="flex w-full justify-around">
            ...
            <a href="https://www.instagram.com/sivanhackam/" target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-[#E1306C]/15 border border-[#E1306C] hover:bg-[#E1306C]/30 flex items-center justify-center transition-colors">
              <svg className="w-5 h-5" fill="url(#ig-grad-mobile)" viewBox="0 0 24 24">
                <defs><linearGradient id="ig-grad-mobile" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stopColor="#F58529"/><stop offset="50%" stopColor="#E1306C"/><stop offset="100%" stopColor="#833AB4"/></linearGradient></defs>
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path fill="#2d6b7a" d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><circle cx="17.5" cy="6.5" r="0.7" fill="#2d6b7a"/>
              </svg>
            </a>
